...
export default function Component() {
  ...
  <HStack spacing={`1em`}>
  <Avatar name={`Jesus Chiroque`} size={`xl`} src={`avatar.jpg`} sx={{"color": "#C3C7CB", "bg": "#171F26", "padding": "2px", "border": "4px", "borderColor": "#14A1F0"}}/>
  ...
  {`Soy un aprendíz de python y estoy entusiasmado con
